...
export class DeleteOp<Conf extends DeltaConf = {}> extends list.ListNode {
     ...
     */
    constructor(len: number, prevValue: DeltaBuilder<any> | null);
    delete: number;
...
export class DeltaBuilder<Conf extends DeltaConf = {}, FixedConf extends boolean = false> extends Delta<Conf> {
     ...
     */
    delete(len: number, prevValue?: DeltaBuilder<any> | null): this;
    /**
     ...
     */
    setAttr<Key extends Extract<keyof DeltaConfGetAllowedAttrs<Conf, FixedConf>, string | number>, Val extends DeltaConfGetAllowedAttrs<Conf, FixedConf>[Key]>(key: Key, val: Val, attribution?: Attribution | null, prevValue?: Val | undefined): DeltaBuilder<DeltaConfOverwrite<Conf, {
     ...
     * }>, FixedConf>}
     */
    deleteAttr<Key extends Extract<keyof DeltaConfGetAllowedAttrs<Conf, FixedConf>, string | number>>(key: Key, attribution?: Attribution | null, prevValue?: any): DeltaBuilder<DeltaConfOverwrite<Conf, {
        attrs: AddToAttrs<DeltaConfGetAttrs<Conf>, Key, never>;
    }>, FixedConf>;
    /**
